...
class TovarsController extends Controller {
    ...
    {
        $tovars = Tovars::with("user")->with("catalogs")->get();
...
$catalogs = Catalogs::pluck("name", "id")->prepend('Please select', null);
	    ...
	    return view('admin.tovars.create', compact("user", "catalogs", "showhide"));
	}
...
$catalogs = Catalogs::pluck("name", "id")->prepend('Please select', null);
		...
		return view('admin.tovars.edit', compact('tovars', "user", "catalogs", "showhide"));
	}
