...
{!! Form::open(array('files' => true, 'route' => config('quickadmin.route').'.tovars.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::text('product_key', old('product_key'), array('class'=>'form-control')) !!}
    ...
    <div class="col-sm-10">
        {!! Form::text('count', old('count'), array('class'=>'form-control')) !!}
