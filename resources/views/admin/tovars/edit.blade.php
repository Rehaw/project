...
<div class="form-group">
    ...
    {!! Form::label('product_key', 'product_key', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::text('product_key', old('product_key',$tovars->product_key), array('class'=>'form-control')) !!}
    ...
    {!! Form::label('catalogs_id', 'category_id', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::select('catalogs_id', $catalogs, old('catalogs_id',$tovars->catalogs_id), array('class'=>'form-control')) !!}
    ...
    <div class="col-sm-10">
        {!! Form::text('count', old('count',$tovars->count), array('class'=>'form-control')) !!}
